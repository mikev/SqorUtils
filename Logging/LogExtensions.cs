...
namespace Sqor.Utils.Logging
{
    public static class LogExtensions
    {
        ...
        public static void LogInfo<T>(this T target, string message, params object[] args)
        {
            Logger.Instance.Log(new LogContext(MessageType.Information, target, target.GetType(), string.Format(message, args), null));
        }
